...
<div id="sample">
  ...
  <p>
    Double click on a node in order to add an employee, or double click in the diagram background to add a new boss.
    Double clicking the diagram uses the <a>ClickCreatingTool</a> with a custom <a>ClickCreatingTool.insertPart</a>
  ...
  <p>
    ...
    Deleting a Node or Link will orphan the child Node and generate a new tree.
    A custom SelectionDeleting <a>DiagramEvent</a> listener will clear out the boss info when the parent is removed.
  </p>
  <p>
