...
<div id="sample">
  ...
  <p>
    This extension's code is TypeScript-only and the source files can be found in the <code>extensionsJSM</code> directory.
    The layout is defined in its own file, as <a href="../extensionsJSM/PackedLayout.ts">extensionsJSM/PackedLayout.ts</a>, with an additional dependency on <a href="../extensionsJSM/Quadtree.ts">extensionsJSM/Quadtree.ts</a>.
  </p>
</div>
    </div>
    <!-- * * * * * * * * * * * * * -->
